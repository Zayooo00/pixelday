  ...
  return (
    ...
    >
      <main className="flex flex-col items-center justify-center flex-1 px-20 text-center">
        <h1 className="text-9xl font-bold text-white text-stroke">Pixel Day</h1>

        <div className="flex mt-6">
          <Link
            href="/sign-in"
            className="px-2 sm:px-10 py-3 m-4 text-2xl text-yellow-700 bg-white rounded-md border-solid border-4 border-yellow-700 transform transition-transform duration-500 hover:scale-110 relative group"
          >
            Sign In
