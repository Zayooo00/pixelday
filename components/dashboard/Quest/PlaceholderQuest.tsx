export function QuestPlaceholder() {
  ...
  return (
    <div className="my-4 flex h-20 w-full transform animate-pulse cursor-pointer items-center justify-center rounded-md border-t-2 border-l-2 border-r-4 border-b-4 border-gray-300 bg-white transition-transform hover:animate-card-bounce">
